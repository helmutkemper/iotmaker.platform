...
func NewEaseInExponentialOutCubic(duration time.Duration, startValue, endValue float64, onStartFunc, onEndFunc, onInvertFunc func(value float64, arguments ...interface{}), onStepFunc func(value, percentToComplete float64, arguments ...interface{}), loop int, arguments ...interface{}) *tween.Tween {
	t := &tween.Tween{
		OnStart:     onStartFunc,
		OnEnd:       onEndFunc,
		Arguments:   arguments,
