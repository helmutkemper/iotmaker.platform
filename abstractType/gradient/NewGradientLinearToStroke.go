...
// point and ending at (x1, y1) point and stroke the image with colors in list
//
...
func NewGradientLinearToStroke(coordinateP0, coordinateP1 Point, colorList []ColorStop) iotmaker_platform_IDraw.IFilterGradientInterface {
	return &Gradient{
