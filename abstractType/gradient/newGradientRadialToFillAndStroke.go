...
func NewGradientRadialToFillAndStroke(coordinateP0, coordinateP1 PointWithRadius, colorList []ColorStop) iotmaker_platform_IDraw.IFilterGradientInterface {
	return &Gradient{
		Type:         KLinearGradientFillAndStroke,
