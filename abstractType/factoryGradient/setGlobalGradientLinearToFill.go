...
//
func SetGlobalGradientLinearToFill(platform iotmaker_platform_IDraw.IDraw, coordinateP0, coordinateP1 point.Point, colorList []gradient.ColorStop) iotmaker_platform_IDraw.IFilterGradientInterface {
