...
func SetGlobalGradientRadialToFill(platform iotmaker_platform_IDraw.IDraw, coordinateP0, coordinateP1 point.PointWithRadius, colorList []gradient.ColorStop) iotmaker_platform_IDraw.IFilterGradientInterface {
