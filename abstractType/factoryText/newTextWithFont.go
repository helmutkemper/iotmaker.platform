...
func NewTextWithFont(platform iotmaker_platform_IDraw.IDraw, shadow iotmaker_platform_IDraw.IFilterShadowInterface, color interface{}, gradient iotmaker_platform_IDraw.IFilterGradientInterface, labelFont font.Font, label string, x, y int, density interface{}, iDensity iotmaker_platform_coordinate.IDensity) text.Text {
