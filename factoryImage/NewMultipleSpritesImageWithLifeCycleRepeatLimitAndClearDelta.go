...
func NewMultipleSpritesImageWithLifeCycleRepeatLimitAndClearDelta(platform iotmaker_platform_IDraw.IDraw, img interface{}, spriteWidth, spriteHeight, spriteFirstElementIndex, spriteLastElementIndex float64, spriteChangeInterval time.Duration, xImageOut, yImageOut, widthImageOut, heightImageOut, clearRectDeltaX, clearRectDeltaY, clearRectDeltaWidth, clearRectDeltaHeight, lifeCycleLimit float64, lifeCycleRepeatInterval time.Duration, lifeCycleRepeatLimit float64, density interface{}, iDensity iotmaker_platform_coordinate.IDensity) *image.MultipleSprites {
